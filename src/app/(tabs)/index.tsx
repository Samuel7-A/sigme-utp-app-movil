      ...
      <View style={styles.header}>
        ...
        <View style={{ position: 'relative' }}>
          ...
          <View style={{
            ...
            backgroundColor: '#FFC107', width: 14, height: 14, borderRadius: 7,
            alignItems: 'center', justifyContent: 'center',
          }}>
            <Text style={{ fontSize: 8, fontWeight: '700', color: '#000' }}>1</Text>
          </View>
        </View>
      </View>
        ...
        <View style={styles.reservationCard}>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <View style={{
              ...
              backgroundColor: '#FADADD', alignItems: 'center', justifyContent: 'center',
              marginRight: 10,
            }}>
